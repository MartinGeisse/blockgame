...
public final class DefaultResourceManager implements ResourceManager {
	...
	/* (non-Javadoc)
	 * @see name.martingeisse.blockgame.resource.ResourceManager#getTexture(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see name.martingeisse.blockgame.resource.ResourceManager#getFont(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see name.martingeisse.blockgame.resource.ResourceManager#getSound(java.lang.String)
	 */
	@Override
