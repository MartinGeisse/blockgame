...
import name.martingeisse.blockgame.system.FixedWidthFont;
...
public final class DefaultResouceLoader implements ResourceLoader {
	...
	/* (non-Javadoc)
	 * @see name.martingeisse.blockgame.resource.ResourceLoader#loadTexture(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see name.martingeisse.blockgame.resource.ResourceLoader#loadFont(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see name.martingeisse.blockgame.resource.ResourceLoader#loadSound(java.lang.String)
	 */
	@Override
